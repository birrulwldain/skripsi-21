...
% Membuat kata "halaman" di daftar gambar dan tabel
\addtocontents{lof}{~\hfill \textit{Halaman}\par}
\addtocontents{lot}{~\hfill \textit{Halaman}\par}

% Membuat kata "halaman" di daftar lampiran
...
% Agar di setiap caption tabel dan gambar diakhiri titik dan dicetak tebal
...
% Agar tabel panjang berpindah ke halaman berikutnya (by RennyAdr)
\usepackage{longtable}

% Untuk page landscape (by RennyAdr)
...
\captionsetup[lstlisting]{
    ...
    indention=0pt,    
    aboveskip=10pt,     % Spasi di atas caption
    belowskip=5pt,            % Hapus indentasi pada baris kedua+
}
...
% Untuk cite url
\usepackage{url}
\usepackage{microtype} % pengaturan spasi paragraf
...
% Untuk daftar program (by RennyAdr)
\makeatletter
...
% Pengaturan untuk daftar pustaka (tab di daftar pustaka -Indah)
...
% Jika menggunakan halaman pengesahan berformat PDF, bisa menggunakan:
...
\titleformat{\section}{\normalfont\bfseries\uppercase}{\thesection}{1.7em}{} % Section kapital, daftar isi non-kapital
