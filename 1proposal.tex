...
\documentclass[dvipsnames]{1proposal}
...
% \usepackage[numbers]{natbib} % Untuk kutipan
...
% Preambul (di bagian sebelum \begin{document})
...
\newcounter{lampiran}
% Perintah \lampiran untuk menyederhanakan penulisan lampiran
\newcommand{\lampiran}[1]{%
  ...
  \addcontentsline{apc}{appendices}{Lampiran \thelampiran. #1}% Tambahkan ke DAFTAR LAMPIRAN tanpa nomor
}
...
\usepackage{tabularx} % Untuk environment tabularx dan kolom X
...
\captionsetup[figure]{labelfont={normalfont}, textfont={normalfont},     singlelinecheck=true,    % Nonaktifkan penengahan otomatis
...
singlelinecheck=true,    % Nonaktifkan penengahan otomatis
justification=raggedright, % Rata kiri penuh
labelsep=space,           % Spasi antara label dan teks
format=hang,              % Format "hang" untuk indentasi
...
\fancypagestyle{daftarpustaka}{
  ...
  \fancyfoot[]{\thepage} % Halaman pertama di tengah
  \fancyfoot[]{\thepage} % Halaman selanjutnya di kanan
}
