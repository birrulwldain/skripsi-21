...
\documentclass[dvipsnames]{3skripsi}
...
% \newcommand{\listappendicesname}{DAFTAR LAMPIRAN} % Removed duplicate
% \newlistof{appendices}{apc}{\listappendicesname} % Removed duplicate
% \newcommand{\appendices}[1]{\addcontentsline{apc}{appendices}{#1}} % Removed duplicate definition
% \newcommand{\newappendix}[1]{\section*{#1}\appendices{#1}} % Removed duplicate definition
...
% \newcommand{\listappendicesname}{DAFTAR LAMPIRAN} % Removed duplicate definition
\newlistof{appendices}{apc}{DAFTAR LAMPIRAN}
\makeatletter
